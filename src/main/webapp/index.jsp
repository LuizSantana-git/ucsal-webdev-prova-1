...
<body>
	...
	<div class="container-geral">
		...
		ArrayList<AulaDto> lista = (ArrayList<AulaDto>) sessao.getAttribute("aulas");
		if (lista != null) {
		...
		<div class="container-aula">
			<div class="container-linha1">
				<div class="info">
					Data: <span class="texto"><%=aula.data%></span>
				</div>
				<div class="info">
					Hora: <span class="texto"><%=aula.horario%></span>
				</div>
				<div class="info">
					Duração(h): <span class="texto"><%=aula.duracao%></span>
				</div>
			</div>
			<div class="container-linha2">
				<div class="info">
					Disciplina: <span class="texto"><%=aula.disciplina%></span>
				</div>
				<div class="info">
					Assunto: <span class="texto"><%=aula.assunto%></span>
				</div>
			</div>
