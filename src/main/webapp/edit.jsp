...
<body>
	...
	<header class="container-cabecalho">
		...
		<h3>
			Editando: aula de <span id="nome-disciplina"><%= dto.disciplina%></span>
		</h3>
	</header>
	...
	<div class="container-geral">
		...
		<div class="container-aula-edit">
			...
			<div class="container-linha1">
				<div class="info">
					Data: <input id="data-id" type="date" class="inp-data" value="<%= dto.data %>">
				</div>
				<div class="info">
					Horário: <input id="hora-id" type="time" class="inp-hora"
						value="<%= dto.horario%>">
				</div>
				<div class="info">
